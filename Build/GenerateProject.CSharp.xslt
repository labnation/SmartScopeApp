  ...
  <xsl:template name="configuration"
    ...
    <xsl:choose>
      ...
      <xsl:when test="$root/Input/Generation/Platform = 'iOS' or $root/Input/Generation/Platform = 'tvOS'">
        ...
        <xsl:if test="$root/Input/Properties/iOSOptimizePNG">
          <OptimizePNGs>
            <xsl:value-of select="$root/Input/Properties/iOSOptimizePNG" />
          </OptimizePNGs>
        </xsl:if>
        <MtouchUseArmv7>
          <xsl:choose>
  ...
  <xsl:template match="/">
    ...
    <Project
      ...
      <xsl:variable name="item_types">
        ...
        <ItemType>ImageAsset</ItemType>
        <ItemType>NativeReference</ItemType>
      </xsl:variable>
